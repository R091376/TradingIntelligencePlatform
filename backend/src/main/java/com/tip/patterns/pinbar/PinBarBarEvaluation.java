...
/** Result of evaluating one closed bar for pin-bar patterns. */
public final class PinBarBarEvaluation {
    ...
    public static final class Builder {
        ...
        public PinBarBarEvaluation build() {
            return new PinBarBarEvaluation(advanced, newlyDetected, events, stillOpen, closedThisBar);
        }
    }
}
