...
/**
 * Result of evaluating one closed bar for Breakdown (advances + optional new detect).
 */
public final class BreakdownBarEvaluation {
    ...
    public static final class Builder {
        ...
        public BreakdownBarEvaluation build() {
            return new BreakdownBarEvaluation(advanced, newlyDetected, events, stillOpen, closedThisBar);
        }
    }
}
